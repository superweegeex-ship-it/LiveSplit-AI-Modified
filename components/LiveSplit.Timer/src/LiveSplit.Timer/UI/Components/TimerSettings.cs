...
public partial class TimerSettings : UserControl
{
    ...
    public bool UseMultiColorTextGradient { get; set; }
    ...
    public TimerSettings()
    {
        ...
        ShowGradient = true;
        UseMultiColorTextGradient = false;
    ...
    public void SetSettings(XmlNode node)
    {
        ...
        UseMultiColorTextGradient = SettingsHelper.ParseBool(element["UseMultiColorTextGradient"], false);
        TimerColor = SettingsHelper.ParseColor(element["TimerColor"], Color.FromArgb(170, 170, 170));
        TextGradientTopColor = SettingsHelper.ParseColor(element["TextGradientTopColor"], Color.White);
        TextGradientMiddleColor = SettingsHelper.ParseColor(element["TextGradientMiddleColor"], TimerColor);
        TextGradientBottomColor = SettingsHelper.ParseColor(element["TextGradientBottomColor"], Color.FromArgb(120, 120, 120));
    ...
    private int CreateSettingsNode(XmlDocument document, XmlElement parent)
    {
        ...
        SettingsHelper.CreateSetting(document, parent, "UseMultiColorTextGradient", UseMultiColorTextGradient) ^
        SettingsHelper.CreateSetting(document, parent, "TimerColor", TimerColor) ^
        SettingsHelper.CreateSetting(document, parent, "TextGradientTopColor", TextGradientTopColor) ^
        SettingsHelper.CreateSetting(document, parent, "TextGradientMiddleColor", TextGradientMiddleColor) ^
        SettingsHelper.CreateSetting(document, parent, "TextGradientBottomColor", TextGradientBottomColor) ^
